...
function WriteExam() {
  ...
  const calculateResult = async () => {
    try {
      ...
      let verdict = "Pass";
      if ((correctAnswers.length)*4 < examData.passingMarks) {
        verdict = "Fail";
      }
  ...
  return (
    examData && (
      <div className="mt-2">
        ...
        <div className="flex parent-quiz-title">
          <div className="gapper"></div>
        <h1 className="quiz-title">{examData.name}</h1>
        <div className="timer">
        ...
        {view === "questions" && (
          <div className="flex flex-col gap-2 qustion-div">
            <div className="flex justify-between">
              <h1 className="question-line">
          ...
          <div className="flex  items-center mt-2 justify-center result">
            <div className="flex flex-col gap-2">
              <h1 className="text-2xl">RESULT</h1>
               <div className="divider"></div>
              <div className="flex flex-col marks gap-1">
                {/* <h1 className="text-md">Total Marks : {examData.totalMarks}</h1> */}
                <h1 className="text-xl">
                  Obtained Marks : {(result.correctAnswers.length)*4 - result.wrongAnswers.length}
                </h1>
                <h1 className="text-xl">
                  Right Answers : {result.correctAnswers.length}
                </h1>
                <h1 className="text-xl">
